...
export const endpoints = Object.freeze({
  especialidades: `${VITE_URL_BASE}${VITE_API_ESPECIALIDADES}`,
  medicos: `${VITE_URL_BASE}${VITE_API_MEDICOS}`,
  pacientes: `${VITE_URL_BASE}${VITE_API_PACIENTES}`,
  turnos: `${VITE_URL_BASE}${VITE_API_TURNOS}`,
});
